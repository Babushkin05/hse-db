...
*   **Атрибуты:**
    ...
    *   `Проект`: <u>ProjectID</u>, Title, Description, Budget, Status
    *   `Заявка`: <u>BidID</u>, ProposedCost, ProposedCompletionDate, Status, SubmissionDate, AcceptanceDate, RejectionDate
    *   `Отзыв`: <u>ReviewID</u>, Rating, CommentText
